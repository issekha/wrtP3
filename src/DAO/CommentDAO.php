...
class CommentDAO extends DAO 
{
    ...
    public function findAllByArticle($articleId) {
        ...
        $sql = "select com_id, com_content, com_author, report from t_comment where art_id=? order by com_id";
     ...
     *
     * @param \cmsWRT\Domain\Comment $comment The comment to save
     */
    ...
    public function deleteAllByUser($userId) {
        $this->getDb()->delete('t_user', array('usr_id' => $userId));
    }
