...
use cmsWRT\Domain\User;
use cmsWRT\Form\Type\ArticleType;
use cmsWRT\Form\Type\CommentType;
use cmsWRT\Form\Type\UserType;
use cmsWRT\Form\Type\EditCommentType;
...
class AdminController {
    ...
    public function editCommentAction($id, Request $request, Application $app) {
        ...
        $commentForm = $app['form.factory']->create(EditCommentType::class, $comment);
    ...
    public function addUserAction(Request $request, Application $app) {
        ...
        if ($userForm->isSubmitted() && $userForm->isValid()) {
            ...
            $app['session']->getFlashBag()->add('success', 'Utilisateur ajouté.');
        }
